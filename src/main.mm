...
int my_bonusMeatballsGathered(id self, SEL _cmd) {
    ...
    return ((int (*)(id, SEL))RunningMinigameViewController_bonusMeatballsGathered)(self, _cmd);
}
...
static void initialize() {
	...
	rebind_symbols((struct rebinding[1]){{"bonusMeatballsGathered:param2:", (void *)my_bonusMeatballsGathered, (void **)&RunningMinigameViewController_bonusMeatballsGathered}}, 1);
